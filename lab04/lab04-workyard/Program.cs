...
namespace FirstTry {
  ...
  static class Demo {
    // TODO: Add WithName to Person
    // TODO: Extract renaming logic into method 'Rename'
...
namespace RequiredProps {
  // DEMO: Use required/init to define the same data structures
}
#endregion
#region Immutable people - self type

namespace SelfType {
  // DEMO: Make Person generic
}
#endregion
