...
public class Program {
	...
	private static decimal GetAvgRate(List<Exchange> list) {
		decimal sum = 0;
	...
	public static void Main(string[] args) {
		...
		// TODO #1: MapPost for /rates with RatePost to Add
		// TODO #1: MapDelete for /rates/{id} with string id to remove 

		// TODO #2: Make GET request asynchronous!

		// TODO #3: Add locking - try with lock, Monitor.Enter
		// TODO #3: What's the best version with lock?

		// TODO #4: Use ImmutableList! How does Delete & Put look?s
